    ...
    <div class="edit_produt_area">
        ...
        <section class="edit_product_area">
            <article class="edit_product_image">
                <p class="product_edit_title_info">Carregar imagem de capa</p>
...
<body class="body_edit_product">
    <div class="area_edit_product">
        ...
        <p class="info_edit_product">Preencha as informações necessárias para editar produtos do catálogo do site</p>
        <section class="edit_product_area">
            <article class="edit_product_image">
                <p class="product_title_info">Carregar mais imagens</p>
            ...
            <aside class="edit_product_details">
                <div class="product_details_collumn">
                    ...
                    <article class="input_product_name">
                        <p class="product_title_info">Editar o nome do produto</p>
                        <input type="text" class="input_product_info" placeholder="Titulo" required>
                        <span class="error-message">Campo vazio não é aceito!</span>
                    </article>

                    <article class="input_product_category">
                        <p class="product_title_info">Selecione a categoria a qual o produto pertence</p>
