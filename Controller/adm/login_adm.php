<?php
include '../cliente/menu_login.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
        ...
        <div class="login_area">
            ...
            <div class="login_form_adm">
                ...
                <form class="form_login" action="login.php" method="POST">
                    ...
                    <button type="button" class="button_adm" onclick="window.location.href='pg_inicial_adm.php'">LOGIN</button>
                    <a href="recuperar_senha_login1.php">Esqueci minha senha</a>
                    <a href="../cliente/login.php">Área do cliente aqui</a>
                </span>
                </form>
            </div>
        </div>
