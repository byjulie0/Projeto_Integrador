...
if ($result->num_rows > 0) {
    try {
        ...
        $_SESSION['popup_message'] = 'Clique no botão do WhatsApp e converse com um atendente para mais detalhes. Você pode consultar a situação do seu pedido na página de histórico. Código do pedido: #' . $id_pedido;
