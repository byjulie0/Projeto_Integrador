...
<head>
    ...
    <link rel="stylesheet" href="../../view/public/css/cliente/pg_priva_segu.css">
...
<body>
    <section class="whole-page-content-pes">
        ...
        <div class="terms-pes">
            ...
            <div class="term-pes">
                <span class="term-title-pes">2. Coleta de Dados Pessoais</span>
                <p class="term-text-pes">
                    Durante sua navegação e uso dos nossos serviços, podemos coletar as seguintes informações:
                </p>
                <ul class="term-text-pes">
                    <li>Dados cadastrais: nome completo, CPF, e-mail, telefone, endereço, CEP e data de nascimento.</li>
                    <li>Dados de pagamento: informações necessárias para processar compras de forma segura.</li>
                    <li>Dados de navegação: endereço IP, navegador, dispositivo e páginas acessadas.</li>
            ...
            <div class="term-pes">
                <span class="term-title-pes">3. Finalidade do Tratamento</span>
                <p class="term-text-pes">
                    Os dados pessoais são utilizados para:
                </p>
                <ul class="term-text-pes">
                    <li>Processar pedidos e transações de compra.</li>
                    <li>Entregar animais e produtos agropecuários adquiridos.</li>
                    <li>Enviar comunicações sobre pedidos, promoções e atualizações (com consentimento prévio).</li>
                    <li>Garantir a segurança das operações e prevenção de fraudes.</li>
                    <li>Cumprir obrigações legais, fiscais e contratuais.</li>
                    <li>Melhorar a experiência do usuário e otimizar nossos serviços.</li>
                </ul>
            </div>
            ...
            <div class="term-pes">
                ...
                <ul class="term-text-pes">
                    ...
                    <li>Certificados SSL para comunicação segura entre o usuário e o servidor.</li>
                    <li>Controle de acesso restrito aos dados apenas a funcionários autorizados.</li>
                    <li>Monitoramento constante e backups regulares do sistema.</li>
                    <li>Armazenamento em servidores seguros e conformes com a legislação vigente.</li>
                </ul>
            </div>
            ...
            <div class="term-pes">
                <span class="term-title-pes">7. Direitos do Usuário</span>
                <p class="term-text-pes">
                    Conforme a LGPD, você tem direito de:
                </p>
                <ul class="term-text-pes">
                    <li>Solicitar confirmação da existência de tratamento de seus dados.</li>
                    <li>Ter acesso, correção e atualização de suas informações pessoais.</li>
