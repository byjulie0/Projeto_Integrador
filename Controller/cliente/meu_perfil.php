        ...
        <div class="visualizar-dados-geral">
            ...
            <div class="visualizar-dados-geral0">
                <div class="visualizar-dados-geral1">
                    <p class="vizualizar-dados-geral-nome"><label class="visualizar-dados-label">Nome: </label>Fulano da
                        Silva Soares</p>
                    <p class="vizualizar-dados-geral-telefone"><label class="visualizar-dados-label">Telefone:
                        </label>+55 67 XXXXX-XXXX</p>
                    <p class="vizualizar-dados-geral-email"><label class="visualizar-dados-label">E-mail:
                        </label>sample123@gmail.com</p>
                </div>
                <div class="visualizar-dados-geral2">
                    <p class="vizualizar-dados-geral-endereco"><label class="visualizar-dados-label">Endereço:
                        </label>Rua General Exemplo do Exemplo, 24 - Bairro Exemplo, Campo Grande-MS</p>
                    <p class="vizualizar-dados-geral-datanasc"><label class="visualizar-dados-label">Data de Nascimento:
                        </label>XX/XX/XXXX</p>
                </div>
            </div>
        </div>
