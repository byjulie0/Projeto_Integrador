...
<body class="body_categoria_campeoes">
    <div class="container_categoria_campeoes">
        ...
        <div class="lotes_geral">
            <div class="lotes_container" id="lotesContainer_campeoes">
                <?php
                $lotes = [
                    ["imagem" => "../../view/public/imagens/nelore1.webp", "nome" => "Boi", "peso" => "380 kg", "raca" => "Nelore", "genealogia" => "PO", "idade" => "24 meses", "preco" => "5.200,00"],
                    ["imagem" => "../../view/public/imagens/nelore1.webp", "nome" => "Boi", "peso" => "420 kg", "raca" => "Nelore", "genealogia" => "PO", "idade" => "28 meses", "preco" => "5.800,00"],
                    ["imagem" => "../../view/public/imagens/nelore1.webp", "nome" => "Boi", "peso" => "350 kg", "raca" => "Nelore", "genealogia" => "PO", "idade" => "22 meses", "preco" => "4.900,00"],
