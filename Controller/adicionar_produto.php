    ...
    <section class="add_product_area">
        <article class="add_product_image">
            ...
            <div class="img_holder">
                <button class="img_holder_button">
        ...
        <aside class="add_product_details">
            <article class="input_product_name">
                ...
                <input type="text" class="input_product_info" placeholder="Titulo">
            </article>
            ...
            <article class="input_product_subcategory">
                ...
                <select name="subcategories" id="bovinos_breed">
                ...
                <select name="subcategories" id="equinos_breed">
                ...
                <select name="subcategories" id="product_types">
                ...
                <select name="subcategories" id="winner_breed">
