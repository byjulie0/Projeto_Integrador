                ...
                <div class="verificar_administrar_pedidos_sessao_coluna_esquerda">
                    <div class="verificar_administrar_pedidos_sessao_coluna">
                        <div class="verificar_administrar_pedidos_sessao_bloco">
                            ...
                            <h5>Visualizações <br>totais do site: <span class="verificar_administrar_pedidos_sessao_zero"><h2>0</h2></span></h5>
                            <i class="fa-solid fa-chevron-left"></i>
                        </div>
                        <div class="verificar_administrar_pedidos_sessao_bloco">
                            <div class="verificar_administrar_pedidos_sessao_bloco_mini">
                            ...
                            <h5>Vendas: <span class="verificar_administrar_pedidos_sessao_zero"><h2>0</h2></span></h5>
                            <i class="fa-solid fa-chevron-left"></i>
                        </div>
                    </div>
                    <div class="verificar_administrar_pedidos_sessao_coluna">
                        <div class="verificar_administrar_pedidos_sessao_bloco">
                            ...
                            <h5>Total de produtos cadastrados: <span class="verificar_administrar_pedidos_sessao_zero"><h2>0</h2></span></h5>
                            <i class="fa-solid fa-chevron-left"></i>
                        </div>
                        <div class="verificar_administrar_pedidos_sessao_bloco">
                            <div class="verificar_administrar_pedidos_sessao_bloco_mini">
                            ...
                            <h5>Usuários <br>cadastrados: <span class="verificar_administrar_pedidos_sessao_zero"><h2>0</h2></span></h5>
                            <i class="fa-solid fa-chevron-left"></i>
                        </div>
                    </div>
