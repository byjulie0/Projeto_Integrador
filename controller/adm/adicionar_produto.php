        ...
        <aside class="add_product_details">
            <div class="product_details_collumn">
                ...
                <article class="input_product_quantity">
                    ...
                    <input type="number" placeholder="Quantidade" class="input_product_info" name="quantidade" required
                        min="0">
                </article>
            ...
            <div class="product_details_collumn">
                ...
                <article class="input_product_quantity">
                    ...
                    <input type="number" placeholder="Peso em quilos" class="input_product_info" name="peso" required
                        min="0">
                </article>
                ...
                <article class="input_product_quantity">
                    <p class="product_title_info">Insira a descrição do produto<span class="mandatory_space">*</span>
                    </p>
                    <textarea id="descricao" name="descricao" wrap="soft" placeholder="Descrição..."
                        class="input_product_info product_details" required></textarea>
                </article>
            </div>
        </aside>
    </section>
