document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mapeamento de categorias para subcategorias (corrigido para match com HTML)
    ...
    function handleCategoryChange() {
        subcategorySelects.forEach(select => {
            ...
            select.removeAttribute('required'); // Remove required ao trocar categoria
        });
        ...
        if (this.value && categoryToSubcategoryMap[this.value]) {
            ...
            if (subcategorySelect) {
                ...
                subcategorySelect.setAttribute('required', 'required'); // Adiciona required
            }
        }
    }
