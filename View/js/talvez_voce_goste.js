function initCarrossel() {
    const container = document.getElementById('carrossel-cards2');
    if (!container) return;
  
    const cards = container.querySelectorAll('.card_cliente');
    const leftArrow2 = document.getElementById('arrow-esquerda2');
    const rightArrow2 = document.getElementById('arrow-direita2');
